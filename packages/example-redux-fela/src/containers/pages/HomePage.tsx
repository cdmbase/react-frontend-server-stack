...
import {
    ...
    Text,
    ToggleBaseline,
} from '@redux-bootstrap/react-common';
import { Link, Title } from '../../components';

const HomePage = () => (
    <Box>
        <Title message="Redux-Bootstrap" />
        <PageHeader
            heading="Redux Bootstrap"
            description="Starter kit for univeral full-fledged Redux apps."
        />
        <Heading size={1}>
            Heading
            </Heading>
      ...
      eiusmod tempor incididunt ut labore et dolore magna aliqua.
        ...
        <Link display="block" to="https://github.com/cdmbase/react-frontend-server-stack">
            github.com/cdmbase/react-frontend-server-stack
      </Link>
