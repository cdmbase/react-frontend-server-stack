...
export default class Document extends Component {
    ...
    static childContextTypes = {
        _documentProps: ProptTypes.any
    }

    constructor (props) {
        super(props);
        const { __NEXT_DATA_, nextCSS } = props;
        if (nextCSS) {
            __NEXT_DATA__.ids = nextCSS.ids;
        }
    }
...
export class Main extends Component {
    ...
    render () {
        const { html, __NEXT_DATA__, staticMarkup } = this.context._documentPorps;
        return <div>
...
export class NextScript extends Component {
    ...
    render () {
        ...
        return <div>
            ...
            <script type='text/javascript' src='/_next/common.js' />
            </div>
    }
}
